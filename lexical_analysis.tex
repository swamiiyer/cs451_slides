...
From $s_0$, scanning the symbol $a$, we want to go into a state that reflects all the states we could be in after scanning an $a$ in the NFA, which are 2, and via $\epsilon$-moves 5, 6, 7, 9 and 10
\begin{align}
