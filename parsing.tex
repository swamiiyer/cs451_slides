...
The Action and Goto tables for our grammar for simple expressions, and the parse steps for the input \lstinline{id + id * id} are shown below

\bigskip

\begin{minipage}{140pt}
\begin{center}
\visible<2->{\includegraphics[scale=0.35]{{figures/figure03.07}.jpg}}
\end{center}
\end{minipage}
...
0\lstinline$id$5 & \underline{\lstinline$+$}\lstinline$id*id#$ & reduce 6 \\
0\mm{F}3 & \underline{\lstinline$+$}\lstinline$id*id#$ & reduce 4 \\
0\mm{T}2 & \underline{\lstinline$+$}\lstinline$id*id#$ & reduce 2 \\
0\mm{E}1& \underline{\lstinline$+$}\lstinline$id*id#$ & shift 6 \\
0\mm{E}1\lstinline$+$6 & \underline{\lstinline$id$}\lstinline$*id#$ & shift 5 \\
0\mm{E}1\lstinline$+$6\lstinline$id$5 & \underline{\lstinline$*$}\lstinline$id#$    & reduce 6 \\
0\mm{E}1\lstinline$+$6\mm{F}3 & \underline{\lstinline$*$}\lstinline$id#$ & reduce 4 \\
...
0\mm{E}1\lstinline$+$6\mm{T}13\lstinline$*$7\lstinline$id$5 & \underline{\lstinline$#$} & reduce 6 \\
0\mm{E}1\lstinline$+$6\mm{T}13\lstinline$*$7\mm{F}14 & \underline{\lstinline$#$} & reduce 3 \\
0\mm{E}1\lstinline$+$6\mm{T}13 & \underline{\lstinline$#$} & reduce 1 \\
...
The LR(1) canonical collection for our simple expression grammar

\begin{center}
\visible<2->{\includegraphics[scale=0.27]{{figures/lr1_collection}.jpg}}
\end{center}
\end{frame}
...
The Action and Goto tables for our grammar for simple expressions
\begin{center}
...
Relationships among the various categories of grammars
